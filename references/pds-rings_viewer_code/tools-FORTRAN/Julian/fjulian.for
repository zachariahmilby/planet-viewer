...
c*******************************************************************************
        ...
        integer         MAXLEN
        parameter       (MAXLEN = 255)
        logical*1       array1(MAXLEN+1), array2(MAXLEN+1)
...
c*******************************************************************************
        ...
        parameter       (MAXLEN = 255)
        parameter       (PREFLEN = 3)
        logical*1       array1(MAXLEN+1), array2(PREFLEN+1)
        integer*4       GJul_ParseDT
...
c***************************************
        ...
        integer*4 function FJul_ParseDate(string, pref, dutc)
        character*(*)   string, pref
        integer*4       dutc
...
c***************************************
        ...
        integer*4 function FJul_ParseTime(string, isleap, secs)
        character*(*)   string
        logical*4       isleap
        real*8          secs
